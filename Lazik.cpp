...
Lazik::Lazik()
{
	cuboid(0.0f, 5.0f, -2.5f, 10.0f, 2.0f, 5.0f, 0.5, 0.5, 0.5);
	cylinder(0.3f, 1.0f, 4.7f, -2.5f, 5.0f, 0.3, 0.3, 0.3, 20, 0);
	cylinder(0.3f, 5.0f, 4.7f, -2.5f, 5.0f, 0.3, 0.3, 0.3, 20, 0);
	cylinder(0.3f, 9.0f, 4.7f, -2.5f, 5.0f, 0.3, 0.3, 0.3, 20, 0);
